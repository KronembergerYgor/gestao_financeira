...
<div class="container d-flex align-items-center justify-content-center min-vh-100">
    ...
    <div class='boxLogin border rounded shadow-lg p-5 w-75 m-5'>    
        ...
        <x-form-register-revenues-and-expenses route="revenuesAndExpenses.update" method='PUT' :register="$register" spaceProjectId="{{$register->space_project_id}}" :categorys="$categorys" :types="$types" /> 
        <hr>
